...
export default function ChartCard({ config, editable, onRemove, onEdit }: ChartCardProps) {
          ...
          <div className="flex items-center gap-1 shrink-0">
            {onEdit && (
              <button
                ...
                className="w-6 h-6 flex items-center justify-center rounded hover:bg-muted text-muted-foreground hover:text-foreground transition-colors cursor-pointer"
                title="编辑图表"
              >
